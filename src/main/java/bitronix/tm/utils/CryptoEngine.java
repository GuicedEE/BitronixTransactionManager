...
public class CryptoEngine
{
  ...
  -9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9         // Decimal 244 - 255 */
				...
				extends java.io.FilterOutputStream
		{
			...
			{
				@link #w three
             *from which offset max

             *number of
				bytes to
        .
             *read into private boolean encode;
				four
             ...
             *Calls private byte[] b4; // Scratch used in a few places             private boolean suspendEncoding; <var>len</var>
             *private int options; // Record for later written.
             *

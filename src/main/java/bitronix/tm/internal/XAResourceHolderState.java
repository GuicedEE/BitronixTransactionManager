...
public class XAResourceHolderState
{
	...
	{
		this.bean = bean;
		xaResourceHolder = resourceHolder;
	...
	{
		bean = resourceHolderState.bean;
		xaResourceHolder = resourceHolderState.xaResourceHolder;
	...
	public void start(int flags) throws XAException
	{
		...
		if (ended && (flags == XAResource.TMRESUME))
		{
			if (log.isDebugEnabled())
			{
	...
	{
		if (!(obj instanceof XAResourceHolderState) || hashCode != obj.hashCode())
		{
			return false;
		}

		...
		extends TestCase
{
	...
	public void testBindOneJdbc() throws Exception
	{
		...
		String uniqueName = (String) dataSources.keySet()
		                                        .iterator()
		                                        .next();
		...
		assertEquals(5, pds.getDriverProperties()
		                   .size());
	...
	public void testDecryptPassword() throws Exception
	{
		...
		assertEquals(123, pds.getMaxPoolSize());
		assertEquals(3, pds.getDriverProperties()
		                   .size());
	...
	public void testBindOneJms()
	{
		...
		assertEquals(1, pcf.getDriverProperties()
		                   .size());
	...
	public void testBind2WithSomeDefaults()
	{
		...
		assertEquals(0, pds.getDriverProperties()
		                   .size());
	}
	...
	public void testConfigErrors()
	{
		...
		catch (ResourceConfigurationException ex)
		{
			...
			assertEquals(ClassNotFoundException.class, ex.getCause()
			                                             .getClass());
			assertEquals("some.class.Name", ex.getCause()
			                                  .getMessage());
		}
	...
	public void testFormatErrors()
	{
		...
		PoolingDataSource pds = (PoolingDataSource) loader.getResources()
		                                                  .get("some.also.other.unique.Name");

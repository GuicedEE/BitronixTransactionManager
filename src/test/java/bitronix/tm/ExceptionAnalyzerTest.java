		...
		extends TestCase
{
	...
	public void testExceptionAnalyzer()
	{
		...
		TransactionManagerServices.getConfiguration()
		                          .setExceptionAnalyzer(TestExceptionAnalyzer.class.getName());
		assertEquals(TestExceptionAnalyzer.class, TransactionManagerServices.getExceptionAnalyzer()
		                                                                    .getClass());
	}

	public static class TestExceptionAnalyzer

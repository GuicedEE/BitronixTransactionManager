		...
		extends TestCase
{
	...
	public void testPoolGrowth() throws Exception
	{
		...
		{
			assertEquals("unable to get a connection from pool of a PoolingDataSource containing an XAPool of resource pds with 2 connection(s) (0 still available)",
			             ex.getMessage());
		}
	...
	public void testWrappers() throws Exception
	{
		...
		assertEquals(MockitoXADataSource.class.getName(), unwrappedXads.getClass()
		                                                               .getName());
		...
		assertTrue(unwrappedConnection.getClass()
		                              .getName()
		                              .contains("java.sql.Connection") && unwrappedConnection.getClass()
		                                                                                     .getName()
		...
		assertTrue(unwrappedStmt.getClass()
		                        .getName()
		                        .contains("java.sql.Statement") && unwrappedStmt.getClass()
		                                                                        .getName()
		                                                                        .contains("EnhancerByMockito"));
		...
		assertTrue(unwrappedPStmt.getClass()
		                         .getName()
		                         .contains("java.sql.PreparedStatement") && unwrappedPStmt.getClass()
		                                                                                  .getName()
		                                                                                  .contains("EnhancerByMockito"));
		...
		assertTrue(unwrappedCStmt.getClass()
		                         .getName()
		                         .contains("java.sql.CallableStatement") && unwrappedCStmt.getClass()
		                                                                                  .getName()
		                                                                                  .contains("EnhancerByMockito"));
	}
